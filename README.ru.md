...
Не публикуйте `.env`, `state/*.json`, robot token, данные аккаунта и
подписанные ссылки.
...
Это независимый проект сообщества, не связанный с Xiaomi или Roborock.
Установка неофициальных войспаков выполняется на ваш риск.
